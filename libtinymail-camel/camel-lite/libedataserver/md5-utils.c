 ...
 * tm_MD5Context structure, pass it to md5_init, call md5_update as
 ...
 **/
void 
md5_update (tm_MD5Context *ctx, const guchar *buf, guint32 len)
{
	guint32 t;
 ...
 **/
void 
md5_final (tm_MD5Context *ctx, guchar digest[16])
{
	guint32 count;
	guchar *p;
