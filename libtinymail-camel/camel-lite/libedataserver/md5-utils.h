 ...
 * tm_MD5Context structure, pass it to rpmMD5Init, call rpmMD5Update as
...
/* raw routines */
void md5_init (tm_MD5Context *ctx);
void md5_update (tm_MD5Context *ctx, const guchar *buf, guint32 len);
void md5_final (tm_MD5Context *ctx, guchar digest[16]);
